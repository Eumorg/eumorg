### Привет! Я - Женя, Frontend-разработчик!

- 👀 Интересуюсь web-разработкой, автомобилями, путешествиями.

- 📫 Как связаться: eumorg@yandex.ru
...
- **Фронтенд**: JS, React, Hooks API, Redux, HTML5, CSS3
- **Бекенд**: Node.js, Express, Sessions, SSR
- **Базы данных**: PostgreSQL, Sequelize ORM
- **A также**: Jest, GIT, REST
...
[instagram]: https://www.instagram.com/eugmorg
[git]: https://github.com/Eumorg
